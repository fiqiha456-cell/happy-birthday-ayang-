...
let settings = {
    ...
    matrixColor1: '#87ceeb', // Blue color
    matrixColor2: '#4169e1', // Blue color
    sequence: 'HAPPY|BIRTHDAY|KHALILA|❤',
    sequenceColor: '#ff69b4', // Pink color
    gift: '', // No sticker/GIF
    pages: [
        { image: './image/Birthday!/cover.jpg', content: '' },
        { image: './image/Birthday!/photo1.jpg', content: 'Untuk Khalila, perempuan paling indah yang pernah hadir di hidup aku 💙' },
        { image: './image/Birthday!/photo2.jpg', content: 'Makasih udah selalu ada, bahkan di saat dunia lagi berat ✨' },
        { image: './image/Birthday!/photo3.jpg', content: 'Tatapan kamu selalu bikin hati aku tenang 🌌' },
        { image: './image/Birthday!/photo4.jpg', content: 'Aku ga butuh sempurna, aku cuma butuh kamu 💕' },
        { image: './image/Birthday!/photo5.jpg', content: 'Semoga semua hal baik selalu dateng ke hidup kamu 💫' },
        { image: './image/Birthday!/photo6.jpg', content: 'Happy Birthday Khalila ❤️' },
